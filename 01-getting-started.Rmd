...
- Select the *Install dependencies* checkbox 
- Click *Install*   
...
If you successfully negotiated this section, you can skip the next section because you have installed the pacakges we need to get started. 
