...
If you know how to install R packages, you can go directly to the next section.  
...
- Type the name of the package, *drat* (we use the package later) 
...
We only run these lines of code once, so you do not have to type the lines into a script. 
...
At the moment, **midfieldr** is only available from GitHub. 
