...
```{r include = FALSE}
library(knitr)
opts_chunk$set(warning = FALSE, message = FALSE, collapse = TRUE)
...
We will provide pizza (scheduled to arrive at 6 pm).\n\n
...
```{r echo = FALSE}
htmltools::img(src = 
knitr::include_graphics("images/rstudio-environment-x-y.png"), 
...
Too conclude, let's make bar graph of the `titanic` data, 
