...
- Participants are encouraged to bring their own laptops with R and RStudio installed. Follow following the instructions on [Getting started](https://midfieldr.github.io/workshops/getting-started.html). If not, we will have computers avaiable in the room. 
- [Getting started](https://midfieldr.github.io/workshops/getting-started.html) for pre-workshop software installation instructions if you plan on bringing your own 
