...
htmltools::img(src = knitr::include_graphics("figures/data-basics-00.png"), 
        alt   = "logo", 
        style = "left:0px; padding:0px; width:100%;")
```

"Data preparation is not just a first step, but must be repeated many times over the course of analysis as new problems come to light or new data is collected." [@Wickham:2014:tidydata]

Indeed. 

In this 50-minute tutorial we introduce the basic tools of data preparation,  always keeping in mind that many of the steps will be repeated many times over the course of a project. We organize our work into three main categories: 
