...
The rio package can import a lot of different file types, e.g., tab-separated (.tsv), SAS (.sas7bdat), SPSS (.sav), STATA (.dta), MATLAB (.mat), and HTML (.html) among others. 

[[For more information about  rio]](https://cran.r-project.org/web/packages/rio/vignettes/rio.html){target="_blank"} to import, export, and convert data files
