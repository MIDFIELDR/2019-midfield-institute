...
R is an open source language and environment for statistical computing and graphics [@2018rcoreteam], currently ranked by IEEE as the 6th most popular programming language (Python, C, and Java are the top three) [@2017Cass]. If you are new to R, some of its best features, paraphrasing Wickham [-@wickham2014advanced], are: 
