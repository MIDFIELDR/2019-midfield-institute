...
As statistician and graph designer John Tukey [-@Tukey:1977] said, "The greatest value of a picture is when it forces us to notice what we never expected to see." For several years now, we have been using R to explore and present the stories in the MIDFIELD data. To see a sample of our work, you can follow these links: 
...
One can visit  the MIDFIELD [papers and presentations](https://engineering.purdue.edu/MIDFIELD/papers_presentations.html) page for a more comprehensive list. 
