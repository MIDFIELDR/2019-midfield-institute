...
This session consists of three tutorials designed to be completed by an R novice in less than 50 minutes each. The timing has been student-tested, but of course your mileage may vary. 
...
## Tutorial: Graph basics {#graph-basics} 
...
> **Your turn.** Continue to practice with `mpg`.
>
- Write your graph to the `figures` directory with the name `02-graph-basics-mpg.png` 
- Try a 6 in by 8 in figure size 
- The ggsave() code chunk should immediately follow the ggplot() code chunk of the graph you want to save. 
> 
...
## Tutorial: Data basics {#data-basics}  
